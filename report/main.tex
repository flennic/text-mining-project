...
It can be seen in figure \ref{fig:class_distribution} that the class distribution is almost equal. The distribution of review lengths (words) can be seen in figure \ref{fig:review_length_distribution} and it shows an interesting pattern, having some. The percentiles can be found in table \ref{tab:percentiles} and it can be sees that with $177$ words $99$ percent of the reviews do not need to be truncated.
